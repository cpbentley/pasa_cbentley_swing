...
public class RelativeLayout implements LayoutManager2, java.io.Serializable {
    ...
    * 
    */
   private static final long         serialVersionUID = -3068285093331867452L;
    ...
    * @see	   pasa.robcamick.layout.RelativeLayout#minimumLayoutSize
    ...
    *			 subcomponents of the specified container
    * @see		 pasa.robcamick.layout.RelativeLayout#preferredLayoutSize
