...
import pasa.robcamick.layout.RelativeLayout;

public class HSLColorTest extends JPanel implements ChangeListener {
   ...
   private void updateHSL() {
      Color rgb = new Color((Integer) red.getValue(), (Integer) green.getValue(), (Integer) blue.getValue());
   ...
   private void updateRGB() {
      hslColor = new HSLColor((Integer) hue.getValue(), (Integer) saturation.getValue(), (Integer) luminance.getValue());
