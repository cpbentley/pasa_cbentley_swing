...
public class BActionBack extends BActionAbstract implements IMyGui {
   ...
   public BActionBack(SwingCtx sc, IBackForwardable r) {
      super(sc);
      this.r = r;
   }

   public BActionBack(SwingCtx sc, IBackForwardable r, Integer mnemonic) {
      super(sc);
      this.r = r;
   ...
   public void actionPerformed(ActionEvent e) {
      //#debug
      sc.toDLog().pFlow("", null, BActionBack.class, "actionPerformed", ITechLvl.LVL_05_FINE, true);
